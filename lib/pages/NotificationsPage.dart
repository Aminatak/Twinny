...
import 'package:projet_twinny/pages/PostScreenPage.dart';
...
class NotificationsItem extends StatelessWidget {
  ...
  configureMediaPreview(context) {
    ...
    if(type == "like") {
     notificationItemText = "A aimé votre publication.";
    }
    else if(type == "comment") {
      notificationItemText = "A commenté: $commentData.";
    }
    else if(type == "follow") {
      notificationItemText = "Vous suit.";
    }
    else {
      notificationItemText = "Erreur, type $type inconnu.";
    }
  }
