...
class _EditProfilePageState extends State<EditProfilePage> {
            ...
            child: Column(
              children: <Widget>[
                Padding(
                  ...
                  //----------------------------------------------------------//start at 26.41 - 32.12 //Edit Profile at 23.13 user.username, style: TextStyle(fontSize: 14.0, color: Colors
                ),
                Padding(
  ...
  updateUserData() {
    ...
    if(_bioValid && _profileNameValid) {
      ...
      SnackBar successSnackBar = SnackBar(content: Text("Votre profil a été mise à jour"));
